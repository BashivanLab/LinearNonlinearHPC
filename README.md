...
```
To test if the installation works correctly:
```
./manual_control.py --env MiniGrid-Associative-MemoryS13-v0
```

To run the regressions and analyses, additional packages are required:
```
...
- Gym v0.23
- torch-ac 1.1.0
- numpy 1.23.2 and 1.24.2
- matplotlib 3.5.3

Note:
- Gym-minigrid 1.1.0 is only compatible with Gym v0.22-v0.25
- Gym-minigrid 1.2.0 is only compatible with Gym v0.26
- Gym-minigrid 2.0.0 change package name from gym_minigrid to minigrid and they migrated its dependency from gym to gymnasium v0.26


# Original Minigrid readme
---
